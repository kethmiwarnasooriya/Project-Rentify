...
const HomePage = () => {
  ...
  if (isLoggedIn) {
    // User is logged in, set role and navigate
    sessionStorage.setItem('userRole', 'owner');
    console.log('Navigating to owner dashboard');
    navigate('/owner/dashboard');
  } else {
    // User not logged in, save intended destination
  ...
  const handleTenantClick = () => {
    const isLoggedIn = sessionStorage.getItem('isLoggedIn') === 'true';
    if (isLoggedIn) {
      // Set user role as tenant and navigate to tenant dashboard
      sessionStorage.setItem('userRole', 'tenant');
      navigate('/tenant/dashboard');
    } else {
      // Set intended role and redirect to login
