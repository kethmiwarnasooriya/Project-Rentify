...
public class Property {
    ...
    // Relationships
    @ManyToOne(fetch = FetchType.EAGER) // EAGER to include owner data
    @JoinColumn(name = "owner_id", nullable = false) // Foreign key column
    @com.fasterxml.jackson.annotation.JsonIgnoreProperties({"properties", "password", "reservations"}) // Prevent circular reference but include basic owner data
    private User owner;
